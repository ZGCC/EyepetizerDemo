...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    [self setupTabBarCcontroller];
    [self.window makeKeyAndVisible];
    
    return YES;
}

- (void)setupTabBarCcontroller{
    ...
    NSArray *childItems = @[
                            @{kClassKey:@"BaseClassViewController",
                              kTitleKey:@"精选",
                              kImgKey:@"Triangle",
                              kSelImgKey:@"Triangle"},
                            @{kClassKey:@"DiscoveryViewController",
                              kTitleKey:@"发现",
                              kImgKey:@"Circle",
                              kSelImgKey:@"Circle"},
                            @{kClassKey:@"AuthorViewController",
                              kTitleKey:@"作者",
                              kImgKey:@"Rectangle",
                              kSelImgKey:@"Rectangle"},
    ...
    [childItems enumerateObjectsUsingBlock:^(NSDictionary * _Nonnull dic, NSUInteger idx, BOOL * _Nonnull stop) {
        ...
        item.selectedImage = [UIImage imageNamed:dic[kSelImgKey]];
...
- (NSPersistentContainer *)persistentContainer {
    ...
    @synchronized (self) {
        if (_persistentContainer == nil) {
            _persistentContainer = [[NSPersistentContainer alloc] initWithName:@"Eyepetizer"];
